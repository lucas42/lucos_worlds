...
# can run against the actual patched OidcJwtWithClaims/OidcJwtSigningKey
# classes and the real vendored phpseclib3, via Composer's PSR-4 autoloader.
#
...
ARG BASE_IMAGE
FROM ${BASE_IMAGE}
COPY AlgBindingTest.php /tmp/AlgBindingTest.php
